...
public class GenericUDAFCollectList extends AbstractGenericUDAFResolver {
	...
	public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters) throws SemanticException {
		...
		return new GenericUDAFMkCollectionEvaluator2(GenericUDAFMkCollectionEvaluator2.BufferType.LIST);
	}

}

class GenericUDAFMkCollectionEvaluator2 extends GenericUDAFEvaluator implements Serializable {
	...
	// needed by kyro
	public GenericUDAFMkCollectionEvaluator2() {
	}

	public GenericUDAFMkCollectionEvaluator2(BufferType bufferType) {
